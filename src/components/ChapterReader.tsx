...
function VerseDisplay({
  ...
  // Verse-by-verse: each verse on its own line with verse number
  return (
    <div className={`${FONT_SIZE_CLASSES[fontSize]} space-y-2`}>
      {verses.map((v) => (
        <div key={v.verse} className="flex gap-2">
          <sup className="text-[0.65em] text-neutral-400 dark:text-neutral-600 mt-[0.35em] font-sans select-none min-w-[1.5em] text-right">
            {v.verse}
          </sup>
